...
STRINGS: dict[str, dict[str, str]] = {
    "pt": {
        ...
        "search.next": "Próxima →",
        "search.label_query": "Busca",
        "search.label_tags": "Tags",
        "search.label_scope": "Escopo",
        "search.label_type": "Tipo",
        "search.label_source": "Fonte",
        # handoffs
        "ho.title": "Repasses",
        "ho.all": "Todos",
        "ho.open": "Abertos",
        ...
        "obs.total": "observações no total",
        "obs.col_id": "ID",
        ...
        "imp.drop_hint": "Arraste um arquivo JSON aqui",
        "imp.or_click": "ou clique para selecionar",
        "imp.override": "Sobrescrever ID do projeto (opcional):",
        "imp.override_hint": "Deixe vazio para manter os IDs originais do arquivo",
        "imp.button": "Importar",
        "imp.importing": "Importando",
        "imp.invalid_type": "Apenas arquivos .json são aceitos",
        "imp.help": "Importe um arquivo JSON exportado anteriormente. Memórias duplicadas (mesmo ID) serão ignoradas.",
        "imp.help_title": "Como funciona",
        "imp.help_1": "Arquivos JSON exportados do myMem0ry são totalmente compatíveis",
        "imp.help_2": "Memórias com IDs duplicados serão automaticamente ignoradas",
        "imp.help_3": "Repasses (handoffs) também são importados se presentes no arquivo",
        ...
        # export
        "exp.title": "Exportar memórias",
        "exp.description": "Exporte suas memórias como JSON para backup ou transferência entre instâncias.",
        "exp.quick_export": "Exportação rápida",
        "exp.all_memories": "Todas as memórias",
        "exp.global_only": "Apenas globais",
        "exp.by_scope": "Por escopo",
        "exp.by_project": "Por projeto",
        "exp.export_selected_scopes": "Exportar escopos selecionados",
        "exp.export_selected_projects": "Exportar projetos selecionados",
        "exp.no_projects": "Nenhum projeto com memórias encontrado.",
        "exp.exporting": "Exportando",
        # trash
        "trash.title": "Lixeira",
    ...
    "en": {
        ...
        "search.prev": "← Prev",
        "search.next": "Next →",
        "search.label_query": "Query",
        "search.label_tags": "Tags",
        "search.label_scope": "Scope",
        "search.label_type": "Type",
        "search.label_source": "Source",
        # handoffs
        "ho.title": "Handoffs",
        "ho.all": "All",
        "ho.open": "Open",
        ...
        "imp.drop_hint": "Drag a JSON file here",
        "imp.or_click": "or click to select",
        "imp.override": "Override project ID (optional):",
        "imp.override_hint": "Leave empty to keep original IDs from file",
        "imp.button": "Import",
        "imp.importing": "Importing",
        "imp.invalid_type": "Only .json files are accepted",
        "imp.help": "Import a previously exported JSON file. Duplicate memories (same ID) will be skipped.",
        "imp.help_title": "How it works",
        "imp.help_1": "JSON files exported from myMem0ry are fully compatible",
        "imp.help_2": "Memories with duplicate IDs will be automatically skipped",
        "imp.help_3": "Handoffs are also imported if present in the file",
        ...
        # export
        "exp.title": "Export Memories",
        "exp.description": "Export your memories as JSON for backup or transfer between instances.",
        "exp.quick_export": "Quick Export",
        "exp.all_memories": "All memories",
        "exp.global_only": "Global only",
        "exp.by_scope": "By Scope",
        "exp.by_project": "By Project",
        "exp.export_selected_scopes": "Export selected scopes",
        "exp.export_selected_projects": "Export selected projects",
        "exp.no_projects": "No projects with memories found.",
